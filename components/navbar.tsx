...
export function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="px-4 sm:px-6 md:px-8 py-3 md:py-4 flex items-center justify-between">
          {/* Logo */}
          <a href="#" className="relative z-50 flex-shrink-0">
            <div className="flex items-center h-8 sm:h-10 md:h-12">
              <LogoIcon />
            </div>
          </a>

          {/* Desktop Nav - Center positioned */}
          <nav className="hidden md:flex bg-white rounded-sm items-center justify-center p-2 gap-1 lg:gap-2 absolute left-1/2 transform -translate-x-1/2">
            {navItems.map((item) => (
          ...
          <div className="hidden md:block">
            <a
              href="#contact"
              className="px-5 py-2.5 rounded-sm bg-accent text-black font-medium text-sm flex items-center gap-2 p-2 transition-all duration-300 group"
            >
              Get Results
              <ArrowIcon />
            </a>
          ...
          >
            <div className="p-4 sm:p-6 h-full flex flex-col">
              ...
              <motion.div
                ...
                className="pb-8 sm:pb-12 flex justify-center"
              >
                <a
                  href="#contact"
                  onClick={() => setIsMenuOpen(false)}
